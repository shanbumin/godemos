...
func main() {
	...
	sample.CreateTableKeyAutoIncrementSample(start.Client,sample.TableAutoName) //创建表
	sample.PutRowWithKeyAutoIncrementSample(start.Client,sample.TableAutoName)  //写数据
