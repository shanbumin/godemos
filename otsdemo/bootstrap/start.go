...
func init()  {
	...
	DefTunnelClient=tunnel.NewTunnelClientWithConfig(constants.EndPoint,constants.InstanceName,constants.AccessKeyId,constants.AccessKeySecret,conf.DefaultTunnelConfig)
